<template>
    <section class="v-auth">
        ...
        <div class="reg-form">
            ...
            <input v-model="password_var" class="reg-form__text" type="password" name="password_var" placeholder="Введите пароль" />
        </div>
        <button
            @click="authUser"
            class="btn btn--reg"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions([
                'SENDING_AUTH_DATA_IN_API'
            ]),
            authUser(){
                this.SENDING_AUTH_DATA_IN_API(this.login_var, this.password_var)
            }
        }
    }
</script>
